...
const Footer = () => {
  return (
    <div className="pt-1 pb-3 bg-gray-950 text-white justify-right">
      <div
        className="pt-16 pb-16 px-16 lg:px-16 bg-gradient-to-tl from-[#0f172a] via-[#1e293b] to-purple-950 rounded-t-2xl 
      ...
      >
        <div>
          <h1 className="text-2xl font-bold mb-4 pr-5">
            We are dedicated to providing the best AI image generation experience.
          </h1>
        </div>
        <div>
